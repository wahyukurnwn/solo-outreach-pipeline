...
// Baris & kolom sengaja sama persis dengan ProspectTable (modules/prospect) —
// bedanya cuma target Link (/demo/$id, bukan /prospect/$id) karena halaman
// demo publik ini di luar layout _app yang butuh login.
export const DemoProspectTable = ({ prospects }: { prospects: Prospect[] }) => (
